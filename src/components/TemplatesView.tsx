...
export const TemplatesView: React.FC = () => {
  ...
  const handleAITemplatesGenerated = async (templatesData: Omit<UserStoryTemplate, 'id' | 'createdAt' | 'updatedAt'>[]) => {
    try {
      // Save all templates
      await Promise.all(templatesData.map(templateData => createTemplate(templateData)));
      setShowAIGenerator(false);
      refetch();
    } catch (err) {
      console.error('Failed to save AI generated templates:', err);
    }
  };
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900 min-h-screen transition-colors duration-300">
      <div className="mx-auto">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0">
              ...
              <div className="flex items-center justify-between sm:justify-end space-x-3">
                ...
                <button
                  ...
                  className="flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-purple-600 to-blue-600 dark:from-purple-500 dark:to-blue-500 text-white rounded-md hover:from-purple-700 hover:to-blue-700 dark:hover:from-purple-600 dark:hover:to-blue-600 transition-all duration-200 font-medium text-sm shadow-sm"
                >
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-8 sm:p-12 text-center transition-colors duration-300">
              ...
              {templates.length === 0 && (
                <div className="flex flex-col sm:flex-row items-center justify-center space-y-3 sm:space-y-0 sm:space-x-3">
                  ...
                  <button
                    onClick={handleShowAIGenerator}
                    className="flex items-center space-x-2 px-6 py-2 bg-gradient-to-r from-purple-600 to-blue-600 dark:from-purple-500 dark:to-blue-500 text-white rounded-md hover:from-purple-700 hover:to-blue-700 dark:hover:from-purple-600 dark:hover:to-blue-600 transition-all duration-200 font-medium shadow-sm"
                  >
                    <Sparkles className="h-4 w-4" />
        ...
        <AITemplateGenerator
          onSave={handleAITemplatesGenerated}
