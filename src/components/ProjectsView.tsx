...
import { Plus, FileSpreadsheet, Search, FolderPlus, AlertCircle, Loader, Eye, X, Filter, Rocket, BarChart3, Calendar, Users, Grid, List, ChevronDown, Plug } from 'lucide-react';
...
import { ModuleMultiSelectDropdown } from './ModuleMultiSelectDropdown';
...
export const ProjectsView: React.FC = () => {
  ...
  const [showJiraComingSoon, setShowJiraComingSoon] = useState(false);
  const [selectedJiraProject, setSelectedJiraProject] = useState<Project | null>(null);
  ...
  const handleConnectWithJira = (project: Project) => {
    setSelectedJiraProject(project);
    setShowJiraComingSoon(true);
  };
                  ...
                  {viewMode === 'grid' ? (
                    <div className="p-4 sm:p-6">
                      <div className="flex items-start justify-between mb-4">
                        ...
                        {/* JIRA Connect Button - Aligned with title */}
                        <button
                          onClick={(e) => {
                            e.stopPropagation();
                            handleConnectWithJira(project);
                          }}
                          className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 hover:bg-blue-50 dark:hover:bg-blue-900/30 px-2 py-1 rounded-md transition-all duration-200 text-sm font-medium flex items-center space-x-1 flex-shrink-0"
                        >
                        ...
                        <div className="flex items-center space-x-4 min-w-0 flex-1">
                          ...
                          <div className="min-w-0 flex-1">
                            <div className="flex items-center space-x-3 mb-1">
                              ...
                              {/* JIRA Connect Button - Aligned with title in list view */}
                              <button
                                onClick={(e) => {
                                  e.stopPropagation();
                                  handleConnectWithJira(project);
              ...
              <div className="p-4 sm:p-6 space-y-6">
                ...
                <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                  ...
                  <ModuleMultiSelectDropdown
                    ...
                    placeholder="Select modules to include in project"
                  />
                </div>
              ...
              <div className="p-6">
                ...
                <div className="text-center">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 mb-6">
                    JIRA integration for "{selectedJiraProject?.name}" is coming soon! 
                    This feature will allow you to sync your user stories directly with JIRA projects.
                  </p>
                  ...
                  <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 mb-6">
                    ...
                    <ul className="text-sm text-blue-800 dark:text-blue-300 space-y-1 text-left">
                      <li>• Export user stories as JIRA tickets</li>
                      <li>• Sync acceptance criteria</li>
                  ...
                  <button
                    onClick={() => {
                      setShowJiraComingSoon(false);
                      setSelectedJiraProject(null);
                    }}
                    className="w-full bg-blue-600 dark:bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-700 dark:hover:bg-blue-600 transition-colors font-medium"
                  >
                    Got it!
                  </button>
                </div>
